...
.O nó atual "p" tem um filho esquerdo, então buscamos o nó mais à direita na subárvore esquerda de "p", que é 7.
	.Como o nó 7 não tem um ponteiro direito definido, definimos o ponteiro direito 
        do nó 7 para apontar para "p" (7 -> 10) e visitamos o nó 10. Em seguida, 
        atualizamos "p" para o nó esquerdo, ou seja, p = 5.
.O nó atual "p" tem um filho esquerdo, então buscamos o nó mais à direita na subárvore esquerda de "p", que é 3.
	.Como o nó 3 não tem um ponteiro direito definido, definimos o ponteiro direito 
        do 	nó 3 para apontar para "p" (3 -> 5) e visitamos o nó 5. Em seguida, 
        atualizamos "p" para o nó esquerdo, ou seja, p = 3.
...
.O nó atual "p" tem um filho esquerdo. Portanto, buscamos o nó mais à direita na subárvore esquerda de "p", que é 15.
	.Como o nó 15 não tem um ponteiro direito definido, definimos o ponteiro direito  
        do nó 15 para apontar para "p" (15 -> 20) e visitamos o nó 20. Em seguida, 
        atualizamos "p" para o nó esquerdo, ou seja, p = 15.
